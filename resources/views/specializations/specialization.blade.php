...
<!-- breadcrumb -->
@section('PageTitle')
    {{trans('main_sidebar.specialization_list')}}
@stop
<!-- breadcrumb -->
@endsection
@section('content')
...
<div class="row">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="modal-effect btn btn-info" data-effect="effect-scale"
                                           data-id="{{ $specialization->id }}" data-name="{{ $specialization->getTranslation('name','ar') }}"
                                           data-name_en="{{ $specialization->getTranslation('name','en') }}"
                                           data-toggle="modal" href="#edit" title="تعديل">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <a class="modal-effect btn btn-danger" data-effect="effect-scale"
                                           data-id="{{ $specialization->id }}" data-name="{{ $specialization->name }}"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">اضافه تخصص جديد</h6>
                ...
                <div class="modal-body">
                    <form action="{{ route('specialization.store') }}" method="post">
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="exampleInputEmail1">اسم التخصص بالعربيه</label>
                                <input type="text" class="form-control" id="name" name="name" value="{{old('name')}}" required>
                            </div>
                            <div class="col">
                                <label for="exampleInputEmail1">اسم التخصص بالانجليزيه</label>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <label for="recipient-name" class="col-form-label">اسم التخصص بالعربيه</label>
                                <input class="form-control" name="name" id="name" type="text">
                            </div>
                            <div class="col">
                                <label for="recipient-name" class="col-form-label">اسم التخصص بالانجليزيه</label>
    ...
    <div class="modal fade" id="delete">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">حذف تخصص</h6>
                    <button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                </div>
