...
<div class="row">
    <div class="col-lg-4 pull-right">
        <div class="card mb-4">
            <div class="card-body text-center">
                <img src="{{ asset('assets/images/parent.png') }}"
                     alt="avatar"
                     class="rounded-circle img-fluid" style="width: 150px;">
                <h5 style="font-family: Cairo" class="my-3">{{$parent->father_name}}</h5>
                <p class="text-muted mb-1">{{$parent->father_email }}</p>
                <p class="text-muted mb-4">@lang('main_sidebar.father')</p>
            </div>
        </div>
    </div>
    <div class="col-lg-8 pull-left">
        <div class="card mb-4">
            <div class="card-body">
                <form action="{{route('parent.updateProfile',$parent->id)}}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-9">
                            <p class="text-muted mb-0">
                                <input type="text" name="name"
                                       value="{{ $parent->getTranslation('father_name', 'ar') }}"
                                       class="form-control">
                            </p>
                        </div>
                    </div>
