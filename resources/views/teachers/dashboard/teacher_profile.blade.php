...
<div class="row">
    <div class="col-lg-4 pull-right">
        <div class="card mb-4">
            <div class="card-body text-center">
                ...
                <h5 style="font-family: Cairo" class="my-3">{{$teacher->teacher_name}}</h5>
                <p class="text-muted mb-1">{{$teacher->email}}</p>
                <p class="text-muted mb-4">@lang('main_sidebar.teacher')</p>
            </div>
        </div>
    </div>
    <div class="col-lg-8 pull-left">
        <div class="card mb-4">
            <div class="card-body">
                <form action="{{route('teacher.updateProfile',$teacher->id)}}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-9">
                            <p class="text-muted mb-0">
                                <input type="text" name="name"
                                       value="{{ $teacher->getTranslation('teacher_name', 'ar') }}"
                                       class="form-control">
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-9">
                            <p class="text-muted mb-0">
                                <input type="text" name="name_en"
                                       value="{{ $teacher->getTranslation('teacher_name', 'en') }}"
                                       class="form-control">
                            </p>
                        </div>
                    </div>
