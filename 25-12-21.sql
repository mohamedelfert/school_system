...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 25, 2021 at 09:09 PM
...
(4, 1, 2, 9, 12, 1, '2021-12-24', 1, '2021-12-24 21:12:24', '2021-12-24 21:12:24'),
(5, 5, 2, 9, 12, 1, '2021-12-24', 1, '2021-12-24 21:12:24', '2021-12-24 21:12:24'),
(6, 6, 2, 9, 12, 1, '2021-12-24', 0, '2021-12-24 21:12:24', '2021-12-24 21:12:24');
...
(37, '2021_12_23_173642_create_online_classes_table', 24),
(38, '2021_12_23_174642_create_online_classes_table', 25);
...
ALTER TABLE `online_classes`
  ...
  ADD KEY `online_classes_chapter_id_foreign` (`chapter_id`),
...
--
ALTER TABLE `online_classes`
  ADD CONSTRAINT `online_classes_chapter_id_foreign` FOREIGN KEY (`chapter_id`) REFERENCES `chapters` (`id`) ON DELETE CASCADE,
