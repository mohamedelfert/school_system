...
class AddParent extends Component
{
    ...
    public function updated($propertyName)
    {
        $rules = [
            ...
            'mother_id'         => 'required|string|min:10|max:10|regex:/[0-9]{9}/',
        ...
        $validate_messages = [
            ...
            'father_passport.min'   => 'لا يجب ان يكون رقم الباسبور اقل من 10 ارقام',
            'father_passport.max'   => 'لا يجب ان يكون رقم الباسبور اكثر من 10 ارقام',
            'father_phone.regex'    => 'يجب ان يكون رقم الهاتف من ارقام فقط',
            'father_phone.min'      => 'لا يجب ان يكون رقم الهاتف اقل من 10 ارقام',
            ...
            'mother_passport.min'   => 'لا يجب ان يكون رقم الباسبور اقل من 10 ارقام',
            'mother_passport.max'   => 'لا يجب ان يكون رقم الباسبور اكثر من 10 ارقام',
            'mother_phone.regex'    => 'يجب ان يكون رقم الهاتف من ارقام فقط',
            'mother_phone.min'      => 'لا يجب ان يكون رقم الهاتف اقل من 10 ارقام',
        ];
    ...
    public function firstStep(){
        $rules = [
            ...
            'father_id'               => 'required|string|min:14|max:14|regex:/[0-9]{9}/',
            'father_passport'         => 'required|min:10|max:10',
    ...
    public function secondStep(){
        $rules = [
            ...
            'mother_passport'         => 'required|min:10|max:10',
