...
class OnlineClassController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('teachers.dashboard.online_classes.index', compact('title', 'onlineClasses'));
    }
    ...
    public function create()
    {
        ...
        $grades = Grade::all();
        return view('teachers.dashboard.online_classes.add', compact('title', 'grades'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect('online-classes');
    ...
    public function indirectCreate()
    {
        ...
        $grades = Grade::all();
        return view('teachers.dashboard.online_classes.indirect_add', compact('title', 'grades'));
    }
    ...
    public function edit($id)
    {
        ...
        $onlineClass = OnlineClass::where('meeting_id', $id)->first();
        $grades = Grade::all();
        if ($onlineClass->integration == true) {
            return view('teachers.dashboard.online_classes.edit', compact('title', 'grades', 'onlineClass'));
        } else {
            return view('teachers.dashboard.online_classes.indirect_edit', compact('title', 'grades', 'onlineClass'));
        }
    }
